...
var PaymentTransactionModel = /** @class */ (function () {
    ...
    /** From Res To Model */
    PaymentTransactionModel.fromJson = function (res, transactionId) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j;
        console.log("Payment res: ", res);
        return new PaymentTransactionModel({
            transactionId: (_a = res.id) !== null && _a !== void 0 ? _a : transactionId,
            ...
            currency: (_d = res.currency) !== null && _d !== void 0 ? _d : enums_1.UniPayCurrency.sar,
    ...
    Object.defineProperty(PaymentTransactionModel.prototype, "paymentType", {
    ...
    PaymentTransactionModel.prototype.isApplePay = function () {
        return this.paymentType === enums_1.UniPayOption.applepay;
    };
    ...
    PaymentTransactionModel.emptyInstance = function () {
        return new PaymentTransactionModel({
            ...
            amount: 0,
            fee: 0,
            currency: enums_1.UniPayCurrency.sar,
            description: "",
