...
var UniPayConfig = /** @class */ (function () {
    function UniPayConfig(_a) {
        var psKey = _a.psKey, sKey = _a.sKey, environment = _a.environment, redirectUrl = _a.redirectUrl, totalAmountWithVat = _a.totalAmountWithVat, businessName = _a.businessName, description = _a.description, _b = _a.locale, locale = _b === void 0 ? enums_1.UniPayLocale.ar : _b;
        this.psKey = psKey !== null && psKey !== void 0 ? psKey : "";
        this.sKey = sKey;
        this.environment = environment !== null && environment !== void 0 ? environment : enums_1.UniPayEnv.production;
        this.redirectUrl = redirectUrl !== null && redirectUrl !== void 0 ? redirectUrl : "";
        this.totalAmountWithVat = totalAmountWithVat !== null && totalAmountWithVat !== void 0 ? totalAmountWithVat : 0;
        this.businessName = businessName !== null && businessName !== void 0 ? businessName : "";
    ...
    Object.defineProperty(UniPayConfig.prototype, "authorizationPSKey", {
        /** Get Header Authorization Secret Key */
        get: function () {
            var authKey = "Basic ".concat("".concat(this.psKey, ":").toBase64());
            return authKey;
        },
        enumerable: false,
        configurable: true
